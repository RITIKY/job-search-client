...
import Button from "../Sidebars/Button";

const MyJobs = () => {
  // const email = "ritik.yadav@pwc.com";
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`https://job-search-server-u2c3.onrender.com/myJobs/ritik.yadav@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
        setIsLoading(false);
  ...
  const handleDelete = (id) => {
    // console.log(id);
    fetch(`https://job-search-server-u2c3.onrender.com/job/${id}`, { method: "DELETE" })
      .then((res) => res.json)
      .then((data) => {
  ...
  return (
    <div>
      ...
      <section className="py-1 bg-blueGray-50">
        <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-16">
              ...
              <table className="items-center bg-transparent w-full border-collapse ">
                <thead>
                  <tr>
                    ...
                    <th className="px-12 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                      JOB TITLE
                    </th>
