...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className="max-w-screen-2xl  container mx-auto xl:px-24 px-4 md:py-24 py-14">
      ...
      <p className="text-3xl text-black/70 mb-8">
      ...
      <from>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          <div className="flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-offset-gray-300 focus-within:ring-2 focus-within:ring-inset  focus-within:ring-indigo-600 md:w-1/ w-full">
          ...
          <div className="flex md:rounded-s-none rounded shadow-sm ring-1 ring-inset ring-offset-gray-300 focus-within:ring-2 focus-within:ring-inset  focus-within:ring-indigo-600 md:w-1/2 w-full">
